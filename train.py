...
epochs_per_iter = 5000		#Number of iterations before we save our model
batch_size = 500			#Number of training examples pushed to the GPU per batch.
...
model.save_weights(model_basename + '_last_'+str(cur_iter))